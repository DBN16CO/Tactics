...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    private List<Vector2> _tabPositions = new List<Vector2>();
    ...
    void Update() {
        ...
        if (_lerp) {
            ...
            //_selectedTabRT.anchoredPosition = Vector2.Lerp(_selectedTabRT.anchoredPosition, _lerpTabTo, decelerate);
    ...
    private void SetPagePositions() {
        ...
        for (int i = 0; i < _pageCount; i++) {
            ...
            tabPosition = new Vector2(i * (Screen.width / _pageCount),0f);
    ...
    public void OnDrag(PointerEventData aEventData) {
        //Debug.Log(aEventData.delta);
        if (!_dragging) {
            // dragging started
            _dragging = true;
            //_selectedTabRT.anchoredPosition -= new Vector2(aEventData.delta.x, 0f);
