# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2017-01-21 02:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=16)),
                ('attack_type', models.CharField(max_length=25)),
                ('description', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clss', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Static.Class')),
            ],
        ),
        migrations.CreateModel(
            name='Leader',
