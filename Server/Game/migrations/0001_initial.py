    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_move', models.DateField(auto_now=True)),
                ('finished', models.BooleanField(default=False)),
                ('map_path', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Static.Map')),
                ('user_turn', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='User.User')),
            ],
        ),
        migrations.CreateModel(
            name='Game_User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.DecimalField(decimal_places=3, default=0.0, max_digits=5)),
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Game.Game')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='User.User')),
                ('prev_action', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Static.Action')),
