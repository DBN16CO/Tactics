# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2017-04-16 00:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acting_unit', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='acting_unit', to='Static.Class')),
                ('acting_user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='User.Users')),
                ('action', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='Static.Action')),
            ],
        ),
        migrations.CreateModel(
            name='Game',
        ...
        migrations.AddField(
            model_name='action_history',
            name='target',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='target', to='Static.Class'),
        ),
